...
if (isset($_POST['voir'])) {
    ...
    $matriculeQuery = "SELECT COUNT(*) AS count FROM livreurs WHERE matricule = '$matricule'";
    ...
    if ($matriculeResult) {
        ...
        if ($matriculeCount > 0) {
            ...
            $sql = "SELECT SUM(b.prix * t.pourcentage/100) AS total
                    FROM bon b
                    JOIN livreurs t ON b.livreur = t.nom
