...
//  the SQL query 
$sql = "SELECT * FROM demand WHERE commune LIKE '%$search_name%' AND sortie='faux'  LIMIT $results_per_page OFFSET $offset";
...
<div class="container">
    <h2>consulter demandes de livraion :  </h2>
    <table class="center-table">
        ...
        <tbody>
            ...
            <?php
                ...
                echo "<tr><td colspan='6'>No commune trouvé</td></tr>";
            }
            ?>
        </tbody>
    </table>
