...
//  the SQL query 
$sql = "SELECT * FROM techniciens WHERE nom LIKE '%$search_name%' LIMIT $results_per_page OFFSET $offset";
...
if (isset($_GET['delete'])) {
    ...
    $deleteSql = "DELETE FROM techniciens WHERE id = ?";
    ...
    if ($deleteResult) {
        header("Refresh:0; url=./crudtech.php"); // Redirect to the same page after successful deletion
    }
}
?>
...
<div class="container">
    ...
    <table class="">
        <thead>
        <tr>
            <th>Ajouter Technicien</th>
        </tr>
        </thead>
        <tbody>
            <td><a href="addTech.php"><ion-icon name="add-circle-outline"></ion-icon></a></td>
        </tbody>
